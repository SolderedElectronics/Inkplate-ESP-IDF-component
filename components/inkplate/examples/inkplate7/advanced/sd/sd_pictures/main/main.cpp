 ...
 * @brief       Display images from microSD card on Soldered Inkplate 7.
 *
 ...
 *              Supports BMP, JPEG, and PNG files up to 800x480 pixels.
 *
 * Requirements:
 ...
 * - Images should not exceed 800x480 pixels.
