 ...
 * @brief       Text box rendering example for Soldered Inkplate 7.
 *
...
extern "C" void app_main(void) {
  ...
  display.drawTextBox(20, 20, 380, 460, text, 2);

  int offset = 32;
  display.drawTextBox(420, 20 + offset, 780, 220, text, 1, &Roboto_Light_36,
                      27, false, 36);
