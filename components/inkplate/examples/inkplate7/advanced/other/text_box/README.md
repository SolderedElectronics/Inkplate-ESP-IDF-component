...
Render wrapped text inside a bounded box on Soldered Inkplate 7.
...
Text automatically wrapped and displayed within a defined bounding box on the Inkplate 7 e-paper display.
