 ...
 * @brief       Basic RTC time and date example for Soldered Inkplate 7.
 *
 * @details     Demonstrates basic usage of the PCF85063A real-time clock (RTC)
 *              integrated on the Inkplate 7 board. The example shows
 ...
 *
 * Notes:
 * - Inkplate 7 uses the PCF85063A RTC chip.
