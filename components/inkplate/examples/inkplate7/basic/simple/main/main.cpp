 ...
 * @brief       Basic shapes and graphics demo for Soldered Inkplate 7.
 *
 * @details     Demonstrates drawing of basic shapes — filled and outline
 *              rectangles, circles, and triangles — in all six available
 *              colors of the Inkplate 7 display. Also renders text in
 ...
 * - Extra:      logoImg.h header with logo bitmap included in the project
 *
 * Configuration:
 ...
 * 2) The display fills with shapes and text in all six colors.
 *
 * Expected output:
 * - Filled and outline rectangles, circles, and triangles in all six colors.
 * - Text "Welcome to Inkplate 7!" printed in each color.
 * - The Soldered logo drawn in five colors at the bottom of the screen.
 *
 * Notes:
...
extern "C" void app_main(void) {
  ...
  // Draw filled rectangles in all six colors
  ...
  // Draw outline rectangles in all six colors
  ...
  // Draw filled circles in all six colors
  ...
  // Draw outline circles in all six colors
  ...
  // Draw filled triangles in all six colors
  ...
  // Draw outline triangles in all six colors
  ...
  // Print text in all six colors
  display.setTextSize(2);

  display.setTextColor(INKPLATE_BLACK);
  display.setCursor(265, 0);
  display.print("Welcome to Inkplate 7!");
