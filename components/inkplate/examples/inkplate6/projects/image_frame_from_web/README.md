...
In `main.cpp`, `IMAGE_URL` defaults to a public test endpoint (`loremflickr.com`) that redirects to a random 800x600 photo on every request. Change it to point to your own image if desired.
