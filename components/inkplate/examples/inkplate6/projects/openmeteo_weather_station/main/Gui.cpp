/**
 * @file        Gui.cpp
 * @brief       Draws the Open-Meteo weather dashboard on Inkplate 6.
 *
 ...
 *              are unchanged from the original sketch: it already targeted
 *              Inkplate 6's 800x600 panel, unlike the smaller Inkplate
 *              4TEMPERA sibling port, so this version keeps the original's
 *              extra "additional info" panel and day/night indicator that
 *              didn't fit on the smaller display.
 */
