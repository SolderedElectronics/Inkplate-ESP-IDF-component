 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 6.
 *
 * @details     Connects Inkplate 6 to WiFi, sends a text prompt to the
 ...
 * 4) Build and flash to Inkplate 6, then open the Serial Monitor.
 ...
 * - Inkplate 6's 800x600 panel gives the FreeMonoBold18pt7b font plenty of
