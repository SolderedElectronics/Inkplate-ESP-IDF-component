/**
 * Network.h
 * Inkplate ESP-IDF component - Inkplate 6 news example
 *
 * Ported from the Inkplate-Arduino-library Inkplate6_News example's
 ...
 * technique used by this component's Inkplate 5 news example.
 *
