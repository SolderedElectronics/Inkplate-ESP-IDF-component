 ...
 * @brief       Read and display text file from SD card on Soldered Inkplate 6.
 *
 * @details     Demonstrates how to open a .txt file from a FAT-formatted SD
 * card and display its contents on the Inkplate 6 e-paper display. The example
 ...
 * Inkplate 6. 4) The file contents will be read and displayed on the e-paper
 * screen.
 *
 * Expected output:
