...
Play a GIF animation from a microSD card on Soldered Inkplate 6.

## Overview

Loads a GIF file from a FAT-formatted microSD card and plays it back on the Inkplate 6 e-paper screen using partial updates.
