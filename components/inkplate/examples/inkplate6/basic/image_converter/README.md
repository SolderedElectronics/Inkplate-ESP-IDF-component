...
Display a converted image on Soldered Inkplate 6.
...
Use the [Soldered image converter](https://tools.soldered.com/tools/image-converter/) to convert a BMP/PNG to a C array. Select **Inkplate 6** as the target board (1200×825 px).
...
The converted image displayed on the Inkplate 6 e-paper screen.

## Notes

- Images must be sized to fit the display (1200×825 px) or smaller.
