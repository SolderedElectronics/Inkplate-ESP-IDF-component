...
extern "C" void app_main(void) {
  ...
  while (true) {
    ...
    for (int i = 0; i < 600; i += 4) {
      display.drawFastHLine(0, i, 900, BLACK);
    }
    ...
    // Draw rectangle at X = 200, Y = 218 and size of 267x300 pixels
    display.clearDisplay();
    display.drawRect(
        200, 218, 267, 300,
    ...
    // Draw filled black rectangle at X = 200, Y = 218, size of 267x300 pixels
    display.clearDisplay();
    display.fillRect(
        200, 218, 267, 300,
        BLACK); // Arguments are: start X, start Y, size X, size Y, color
    ...
    // Draw rounded rectangle at X = 200, Y = 218 and size of 267x300 pixels and
    // radius of 10 pixels
    display.clearDisplay();
    display.drawRoundRect(200, 218, 267, 300, 10,
    ...
    // Draw filled black rect at X = 200, Y = 218, size of 267x300 pixels and
    // radius of 10 pixels
    display.clearDisplay();
    display.fillRoundRect(200, 218, 267, 300, 10,
                          BLACK); // Arguments are: start X, start Y, size X,
                                  // size Y, radius, color
    displayCurrentAction(display,
    ...
    display.clearDisplay();
    display.drawTriangle(167, 291, 367, 291, 267, 73,
    ...
    // this time)
    display.fillTriangle(275, 255, 333, 255, 267, 109,
                         BLACK); // Arguments are: X1, Y1, X2, Y2, X3, Y3, color
    displayCurrentAction(display,
    ...
    // display at location X = 33, Y = 219 Image is 733x161 pixels and we want
    // to every pixel of this bitmap to be black.
    display.clearDisplay();
    display.image.draw(logo, 33, 219, logo_w, logo_h,
    ...
    for (int i = 0; i < 6; i++) {
      ...
      display.print("Inkplate 6!"); // The actual text you want to show on
                                    // e-paper as String
    }
    ...
    display.clearDisplay();
    display.drawElipse(67, 300, 267, 300, BLACK);
    ...
    display.clearDisplay();
    display.fillElipse(67, 218, 267, 300, BLACK);
