...
Draw shapes and text in 4-bit grayscale mode on Soldered Inkplate 6.
...
Shapes and text in multiple gray shades rendered across the Inkplate 6 e-paper display (1200×825 px).
