...
void app_main(void)
{
  ...
  while(true)
  {
    ...
    displayCurrentAction(display, "Drawing 50 random lines in random colors and thickness");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing 50 random gradient lines in random colors and thickness");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing a grid using horizontal and vertical lines in different colors");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing many filled rectangles randomly in random colors");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing many circles randomly in random colors");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing many filled circles randomly in random colors");
    ...
    displayCurrentAction(display, "Drawing many filled rectangle with rounded edges in random colors");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    displayCurrentAction(display, "Drawing filled triangle inside exsisting one");
    display.display();
    vTaskDelay(pdMS_TO_TICKS(DELAY_MS));
    ...
    display.image.draw(picture1, 100, 100, 500,
                      332); // Arguments are: array variable name, size X, size Y, start X, start Y
