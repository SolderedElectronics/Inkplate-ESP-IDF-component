 ...
 * @brief       Render a Mandelbrot set view on Soldered Inkplate 10 in 1-bit
 ...
 *   the first refresh.
 * - The Inkplate 10 panel is 1200x825 (~1.4545:1), unlike the original
 *   Arduino sketch's near-square viewing window (0.104 x 0.101 in the
 *   complex plane, i.e. ~1.0297:1), which would stretch noticeably if mapped
 *   directly onto a non-square panel. xFrom/xTo below have been widened
 ...
 *     original height  = yTo - yFrom = 0.2102 - 0.1092 = 0.1010 (unchanged)
 *     target aspect    = E_INK_WIDTH / E_INK_HEIGHT = 1200 / 825 = 16 / 11
 *                       ~= 1.454545
 ...
 *   yFrom/yTo are taken unchanged from the original Arduino sketch.
...
// Inkplate 10 panel's 1200x825 (~1.4545:1) resolution instead of the
// original near-square window, which would otherwise appear vertically
// stretched. See the math in the file header comment above.
static const double xFrom = -0.720845, xTo = -0.867755;
