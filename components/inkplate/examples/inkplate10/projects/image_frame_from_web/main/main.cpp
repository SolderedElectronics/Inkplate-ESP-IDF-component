 ...
 * @brief       Digital picture frame for Soldered Inkplate 10.
 *
 * @details     Connects Inkplate 10 to WiFi, downloads a JPEG image from a
...
// Public test endpoint that redirects to a random 1200x825 photo. Replace
// with a URL pointing to your own image if desired.
#define IMAGE_URL "http://loremflickr.com/1200/825"
