 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 10.
 *
 * @details     Connects Inkplate 10 to WiFi, sends a text prompt to the
 ...
 * - Inkplate 10's 1200x825 panel gives the FreeMonoBold18pt7b font even more
 *   room than on Inkplate 6; the reply is wrapped with setTextWrap(true)
