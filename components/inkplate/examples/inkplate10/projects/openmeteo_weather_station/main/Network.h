 ...
 *              fixed-size char buffers filled via snprintf(). This module is
 *              identical to the Inkplate 6 port's Network.h/.cpp: the
 *              Open-Meteo request/parsing logic does not depend on panel
 *              resolution.
 *
