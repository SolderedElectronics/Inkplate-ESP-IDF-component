...
PCF85063A RTC alarm with interrupt-driven wake on Soldered Inkplate 10.

## Overview

Demonstrates using the PCF85063A RTC alarm interrupt (GPIO39) to trigger a hardware interrupt on Inkplate 10. When the alarm fires, the interrupt handler updates the display without polling.
