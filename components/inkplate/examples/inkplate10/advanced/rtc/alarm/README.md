...
Set a PCF85063A RTC alarm and trigger an action on Soldered Inkplate 10.

## Overview

Demonstrates how to configure an alarm on the PCF85063A RTC. When the alarm time is reached, an interrupt fires and the Inkplate 10 display updates to show the alarm event.
