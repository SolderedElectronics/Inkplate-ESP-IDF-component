...
Download and display a BMP image from the web on Soldered Inkplate 10.
...
In `main.cpp`, set `IMAGE_PATH` to point directly to a compatible BMP file.
...
The BMP image downloaded from the web is displayed on the Inkplate 10 e-paper screen.
