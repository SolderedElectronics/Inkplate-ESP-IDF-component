...
Run a web server on Soldered Inkplate 10 to display text from a browser.

## Overview

Starts an HTTP web server on Inkplate 10. After connecting to the same network, open the Inkplate's IP address in a browser, enter text into the web page, and press "Send to display" — the text appears on the e-paper screen.
