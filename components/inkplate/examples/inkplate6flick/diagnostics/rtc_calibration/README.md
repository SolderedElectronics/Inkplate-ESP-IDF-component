...
RTC crystal calibration utility for Soldered Inkplate 6 Flick.

## Overview

Provides a step-by-step procedure for calibrating the PCF85063A RTC crystal oscillator on Inkplate 6 Flick. After pressing the WakeUp button, the RTC is zeroed and elapsed time is displayed every second (alternating partial and full updates). The internal capacitor and clock offset registers can be adjusted to correct drift.
