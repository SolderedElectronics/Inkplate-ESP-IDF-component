 ...
 * @brief       Scrolling text via partial update for Soldered Inkplate 6 Flick.
 *
 ...
 *
 * Expected output:
 * - "This is partial update on Inkplate 6 Flick e-paper display!" scrolling
 *   across the screen.
 *
 * Notes:
...
const char text[] =
    "This is partial update on Inkplate 6 Flick e-paper display! :)";
