...
Download and play a GIF animation from the web on Soldered Inkplate 6 Flick.

## Overview

Connects Inkplate 6 Flick to WiFi, downloads a GIF file from a configured URL, and plays it back on the e-paper display using partial updates.
