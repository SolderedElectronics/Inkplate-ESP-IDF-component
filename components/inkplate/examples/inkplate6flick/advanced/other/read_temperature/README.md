...
Read and display the on-board temperature sensor value on Soldered Inkplate 6 Flick.
...
Current board temperature in °C displayed on the Inkplate 6 Flick e-paper screen.
