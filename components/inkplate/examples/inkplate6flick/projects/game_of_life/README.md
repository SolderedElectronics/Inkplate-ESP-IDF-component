...
- The simulation uses two in-RAM grids sized for the minimum cell size (`MIN_CELLSZ`); on the Inkplate 6 Flick's 1024x758 panel these grids are modestly sized and comfortably fit in RAM.
