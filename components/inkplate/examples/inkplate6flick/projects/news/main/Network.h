/**
 * Network.h
 * Inkplate ESP-IDF component - Inkplate 6 FLICK news example
 *
 * Ported from the Inkplate-Arduino-library Inkplate6FLICK_News example's
 ...
 * technique used by this component's Inkplate 6 news example.
 *
