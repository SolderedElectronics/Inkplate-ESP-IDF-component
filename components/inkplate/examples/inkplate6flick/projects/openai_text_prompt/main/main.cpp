 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 6 Flick.
 *
 * @details     Connects Inkplate 6 Flick to WiFi, sends a text prompt to the
 ...
 * 4) Build and flash to Inkplate 6 Flick, then open the Serial Monitor.
 ...
 * - Inkplate 6 Flick's 800x600 panel gives the FreeMonoBold18pt7b font plenty
 *   of room; the reply is wrapped with setTextWrap(true) starting near the
 *   top-left corner.
