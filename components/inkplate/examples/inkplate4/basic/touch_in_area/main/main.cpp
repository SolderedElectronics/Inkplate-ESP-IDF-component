 ...
 *
 * @details     Demonstrates the touchInArea() function by drawing a filled black
 *              rectangle on screen and moving it diagonally each time it is touched.
 *              A partial update is used for fast on-screen repositioning. When the
 *              rectangle goes off the bottom of the screen it resets to the top-left.
 *
 * Requirements:
 ...
 *
 * Notes:
 * - touchInArea(x, y, w, h) returns true when a finger is detected inside the region.
