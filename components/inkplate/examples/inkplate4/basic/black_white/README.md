...
Comprehensive black & white graphics demo for Soldered Inkplate 4TEMPERA.

## Overview

Cycles through a wide variety of Adafruit GFX drawing primitives in 1-bit (black & white) mode. Each shape is shown for 5 seconds before moving to the next. The demo ends with rotating text.
