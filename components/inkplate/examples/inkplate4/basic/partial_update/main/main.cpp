 ...
 * @brief       Scrolling text via partial update for Soldered Inkplate 4TEMPERA.
 *
 ...
 *
 * Expected output:
 * - "This is partial update on Inkplate 4 e-paper display!" scrolling across the screen.
 *
 * Notes:
