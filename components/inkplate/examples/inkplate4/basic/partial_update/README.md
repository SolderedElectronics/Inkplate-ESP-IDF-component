...
Scrolling text demo using partial display updates on Soldered Inkplate 4TEMPERA.
...
"This is partial update on Inkplate 4 e-paper display!" scrolling continuously from right to left.
