...
Read and display a text file from a microSD card on Soldered Inkplate 4TEMPERA.
...
Create a file named `text.txt` on a FAT-formatted microSD card with any text content. Insert the card into the Inkplate.
