 ...
 *              them on the Inkplate 4TEMPERA e-paper display. The example shows
 *              how to read supported image formats from a FAT-formatted SD card
 *              and render them using the Inkplate graphics library.
 *
 * Requirements:
 ...
 *
 * How to use:
 * 1) Copy a supported image file (e.g. coast.jpg) to a FAT-formatted SD card.
 ...
 * - Maximum supported resolution is 600 x 600 pixels.
 *
