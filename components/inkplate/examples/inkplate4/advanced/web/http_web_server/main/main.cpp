 ...
 * @brief       Standalone WiFi web server example for Soldered Inkplate
 *              4TEMPERA.
 *
...
#define AP_SSID "Inkplate 4TEMPERA"
...
static const char HTML_PAGE[] =
    ...
    "<h2>Inkplate 4TEMPERA Web Server</h2>"
...
static void updatePaper() {
  ...
  g_display->setCursor(20, 160);
  g_display->print("Open Your web browser and open");
  g_display->setCursor(20, 210);
  g_display->print("http://");
  g_display->print(ipStr);
  g_display->print("/");

  g_display->fillRect(10, 260, 580, 4, BLACK);

  g_display->setCursor(20, 280);
