...
Send periodic HTTP POST requests from Inkplate 4TEMPERA to webhook.site.

## Overview

Connects Inkplate 4TEMPERA to a WiFi network and sends periodic HTTP POST requests to [webhook.site](https://webhook.site) — a free online service for inspecting HTTP requests in real time. Useful for testing IoT data transmission.
