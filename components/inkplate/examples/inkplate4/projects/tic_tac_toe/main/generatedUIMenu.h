...
std::string text1_content = "Tic tac toe";
...
std::string text7_content = "Medium";
...
std::string text14_content = "2 player";
...
std::string text2_content = "X first";
...
std::string text3_content = "O first";
...
std::string text15_content = "Human first";
...
std::string text16_content = "Computer first";
...
std::string text12_content = "Start";
...
void mainDrawMenu(Inkplate &display)
{
    ...
    display.print(text6_content.c_str());
    ...
    display.print(text7_content.c_str());
    ...
    display.print(text8_content.c_str());
