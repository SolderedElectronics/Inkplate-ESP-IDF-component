 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 4TEMPERA.
 *
 * @details     Connects Inkplate 4TEMPERA to WiFi, sends a text prompt to the
 ...
 * 4) Build and flash to Inkplate 4TEMPERA, then open the Serial Monitor.
 ...
 * - Inkplate 4TEMPERA's 600x600 panel gives the FreeMonoBold18pt7b font
 *   plenty of room; the reply is wrapped with setTextWrap(true) starting
