 ...
 * @brief       Digital picture frame for Soldered Inkplate 4TEMPERA.
 *
 * @details     Connects Inkplate 4TEMPERA to WiFi, downloads a JPEG image
...
// Public test endpoint that redirects to a random 600x600 photo. Replace
// with a URL pointing to your own image if desired.
#define IMAGE_URL "http://loremflickr.com/600/600"
