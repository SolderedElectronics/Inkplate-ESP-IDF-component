 ...
 *
 * @details     Connects Inkplate 4TEMPERA to WiFi, syncs the wall clock via
 ...
 * - CALENDAR_ID, GOOGLE_API_KEY, and TIME_ZONE_OFFSET_HOURS (in includes.h)
 *   below -> fill in your own values
 *
 * How to use:
