...
Display a converted image on Soldered Inkplate 13SPECTRA.
...
Use the [Soldered image converter](https://tools.soldered.com/tools/image-converter/) to convert a BMP/PNG to a C array. Select **Inkplate 13** as the target board (1600×1200 px).
...
The converted image displayed on the Inkplate 13SPECTRA e-paper screen.

## Notes

- Images must be sized to fit the display (1600×1200 px) or smaller.
