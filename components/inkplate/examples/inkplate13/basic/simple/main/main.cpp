 ...
 * @brief       Basic shapes and graphics demo for Soldered Inkplate 13SPECTRA.
 *
 * @details     Demonstrates drawing of basic shapes — filled and outline
 *              rectangles, circles, and triangles — in all six available
 *              colors of the Inkplate 13SPECTRA display. Also renders text in
 ...
 * - Text "Welcome to Inkplate 13SPECTRA!" printed in each color.
