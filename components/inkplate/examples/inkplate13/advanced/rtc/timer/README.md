...
Use the PCF85063A countdown timer on Soldered Inkplate 13SPECTRA.

## Overview

Configures the PCF85063A RTC countdown timer to fire at a regular interval. When the timer expires, its flag is detected and a counter is incremented and displayed on the Inkplate 13SPECTRA e-paper screen. The timer is then reloaded for the next interval.
