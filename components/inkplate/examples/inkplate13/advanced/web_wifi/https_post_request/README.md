...
Send periodic HTTPS POST requests from Soldered Inkplate 13SPECTRA.

## Overview

Connects Inkplate 13SPECTRA to WiFi and sends periodic HTTPS POST requests to [webhook.site](https://webhook.site) — a free online service for real-time HTTP request inspection. Useful for testing IoT data transmission over HTTPS.
...
- Inkplate 13SPECTRA display shows example information.
