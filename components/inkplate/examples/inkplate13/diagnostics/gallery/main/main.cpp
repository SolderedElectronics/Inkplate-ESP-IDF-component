 ...
 * @brief       SD card image gallery example for Soldered Inkplate 13SPECTRA.
 *
 ...
 *              e-paper screen, then enters deep sleep for 5 minutes.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - A randomly selected image from the SD card displayed on the screen.
