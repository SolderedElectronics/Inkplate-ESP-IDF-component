 ...
 *
 * @details     Ported from the Inkplate13SPECTRA_Quotables Arduino example.
 *              WiFi connection handling is left to app_main() (via
 *              display.wifi), matching the rest of this component's
 *              examples; this file is only responsible for the HTTP GET +
 *              JSON parsing step that the original NetworkUtils::getData()
 *              performed with HTTPClient + ArduinoJson.
 *
