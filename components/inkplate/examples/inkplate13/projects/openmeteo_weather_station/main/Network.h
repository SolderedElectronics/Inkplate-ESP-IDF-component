 ...
 *              Arduino example's src/NetworkFunctions.h. The original used
 ...
 *              fixed-size char buffers filled via snprintf(). The file is
 *              named Network.h/.cpp here (rather than NetworkFunctions.h/
 *              .cpp) to match the naming used by this component's other
 *              Open-Meteo weather station ports (e.g. Inkplate6Color's).
 *
