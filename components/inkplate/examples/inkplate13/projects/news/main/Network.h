/**
 * Network.h
 * Inkplate ESP-IDF component - Inkplate 13SPECTRA news example
 *
 * Ported from the Inkplate-Arduino-library Inkplate13SPECTRA_News example's
 ...
 * verification) together with cJSON (bundled with ESP-IDF), matching the
 * technique used by this component's Inkplate 6Color/Inkplate 6 news
 * examples.
 *
 * Original Arduino version:
 * Soldered
 * https://github.com/SolderedElectronics/Inkplate-Arduino-library/tree/master/examples/Inkplate13SPECTRA_Projects/Inkplate13SPECTRA_News
