 ...
 * @brief       TODO: port from Arduino example "Inkplate13SPECTRA_News" (News) to
 *              ESP-IDF for Soldered Inkplate 13.
 *
 * @details     Scaffold only - not yet ported. See the original Arduino
 *              sketch under
 *              "SolderedElectronics Inkplate-Arduino-library/examples/Inkplate13SPECTRA/Projects/Inkplate13SPECTRA_News/"
...
extern "C" void app_main(void) {
  // TODO: port News from Inkplate13SPECTRA_News.
}
