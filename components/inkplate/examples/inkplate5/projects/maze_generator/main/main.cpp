 ...
 *              Inkplate 5 e-paper display. A simple maze generation
...
// Inkplate 5's larger, non-square 1280x720 panel yields a 61x33 cell grid
// (versus a 27x27 grid on the smaller, square Inkplate 4 panel), filling the
// display edge-to-edge with an even 30px margin on all sides.
