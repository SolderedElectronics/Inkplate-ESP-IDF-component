 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 5.
 *
 * @details     Connects Inkplate 5 to WiFi, sends a text prompt to the
 ...
 * - Inkplate 5's 1280x720 panel gives the FreeMonoBold18pt7b font plenty of
 *   room; the reply is wrapped with setTextWrap(true) starting near the
 *   top-left corner.
