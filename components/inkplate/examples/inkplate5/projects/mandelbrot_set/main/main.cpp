 ...
 * @brief       Render a Mandelbrot set view on Soldered Inkplate 5 in 1-bit
 ...
 *   the first refresh.
 * - The Inkplate 5 panel is 1280x720 (16:9). The original Arduino sketch's
 *   viewing window was close to square, which would stretch noticeably on
 *   this wider panel if mapped directly. xFrom/xTo below have been widened
...
// Inkplate 5 panel's 1280x720 (16:9) resolution instead of the original
// near-square window, which would otherwise appear horizontally stretched.
static const double xFrom = -0.704522, xTo = -0.884078;
