...
- The simulation uses two in-RAM grids sized for the minimum cell size (`MIN_CELLSZ`); on the Inkplate 5's 1280x720 panel this is a larger grid than on smaller boards, so RAM usage scales with display resolution and the chosen cell size range.
