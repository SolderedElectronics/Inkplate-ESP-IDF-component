/**
 * Network.h
 * Inkplate ESP-IDF component - Inkplate 5 news example
 *
 * Ported from the Inkplate-Arduino-library Inkplate5_News example's
 ...
 * technique used by this component's Inkplate 4TEMPERA news example.
 *
