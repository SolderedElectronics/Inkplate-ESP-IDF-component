 ...
 * @brief       WiFi image uploader for Soldered Inkplate 5.
 *
 * @details     Turns Inkplate 5 into a small standalone web app for
 ...
 *              an image from their gallery, scales/crops it to a fixed
 *              canvas in the browser, and POSTs it to the device. The
 *              device then decodes the uploaded JPEG and renders it on the
 *              e-paper display in grayscale.
 *
 * Requirements:
 ...
 * - This example uses the display's default grayscale (3-bit) mode.
 *
