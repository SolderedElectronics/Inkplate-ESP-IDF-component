 ...
 * @brief       OpenAI image generation slideshow for Soldered Inkplate 5.
 *
 * @details     Connects Inkplate 5 to WiFi, sends a text prompt to OpenAI's
 ...
 * 4) Build and flash to Inkplate 5, then open the Serial Monitor.
 ...
 *   Inkplate 5's 1280x720 panel this can clip the top/bottom of the image;
 *   this quirk is carried over from the original rather than "fixed" here.
