 ...
 * @brief       Text box with word wrap example for Soldered Inkplate 5.
 *
...
extern "C" void app_main(void) {
  ...
  display.drawTextBox(100, 100, 500, 500, text);

  // Right box: Roboto Light 36 pt, 27 px line spacing
  int offset = 32;
  display.drawTextBox(600, 100 + offset, 1100, 500, text, 1, &Roboto_Light_36,
                      27, false, 36);
