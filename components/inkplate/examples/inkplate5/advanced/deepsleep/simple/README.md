...
Low-power image slideshow using ESP32 deep sleep on Inkplate 5.
...
- Soldered Inkplate 5
- USB cable (or Li-Po battery for low-power testing)

## Setup

### 1. Prepare image header files

Convert 3 grayscale images (1280×720 px) using the Image Converter and save them as `picture1.h`, `picture2.h`, `picture3.h` in the `main/` folder.
...
- This example uses grayscale mode with full refresh updates.
