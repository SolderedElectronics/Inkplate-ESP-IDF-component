...
Download and play a GIF animation from the web on Soldered Inkplate 5.

## Overview

Connects Inkplate 5 to WiFi, downloads a GIF file from a configured URL, and plays it back on the e-paper display using partial updates.
