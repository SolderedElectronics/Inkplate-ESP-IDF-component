...
Basic "Hello World!" example for Soldered Inkplate 2.

## Overview

Initializes the display and prints "Hello World!" using built-in text rendering compatible with the Adafruit GFX library. A good starting point for any Inkplate 2 project.
