 ...
 * @brief       OpenAI text prompt example for Soldered Inkplate 2.
 *
 * @details     Connects Inkplate 2 to WiFi, sends a text prompt to the
 ...
 * 4) Build and flash to Inkplate 2, then open the Serial Monitor.
 ...
 * - The FreeMonoBold18pt7b font is large relative to Inkplate 2's small
 *   104x212 panel, so only a short response will fit on screen. Keep
 *   PROMPT_TEXT (and the expected reply) short.
...
#define OPENAI_REPLY_MAX_LEN 512
