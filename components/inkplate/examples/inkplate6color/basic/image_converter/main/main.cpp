 ...
 * - Extra:      image_ex.h header with a converted image array included in the project
 *
 * Configuration:
...
extern "C" void app_main(void)
{
    ...
    display.image.draw(image, 0, 0, image_w, image_h, 0); // Arguments are: array variable name, start X, start Y,  size X, size Y
