...
Download and display a BMP image from the web on Soldered Inkplate 6Color.
...
The BMP image downloaded from the web is displayed on the Inkplate 6Color e-paper screen.

## Notes

- Supported BMP formats: Windows BMP, 1/4/8/24-bit color depth.
- Images must fit the display (600×448 px); large images may not render correctly.
