 ...
 * - Extra:      picture1.h, picture2.h, picture3.h headers with 600x448 image arrays
 *
 * Configuration:
 * - Menuconfig -> Inkplate Boards -> Inkplate6Color
 *
 * How to use:
 * 1) Add your three 600x448 images as picture1.h, picture2.h, picture3.h in the main/ folder.
 * 2) Build and flash to Inkplate 6Color.
 * 3) The display cycles through images, sleeping 20 seconds between each.
 *
 * Expected output:
 * - Images displayed one by one, with the board waking from deep sleep to advance the slideshow.
 *
 * Notes:
 * - RTC_DATA_ATTR keeps the slide counter in RTC memory across deep sleep cycles.
...
extern "C" void app_main(void)
{
    ...
    display.image.draw(pictures[slide], 0, 0, 600, 448, 0); // Display selected picture at location X=0, Y=0. All three pictures have resolution of 600x448 pixels
