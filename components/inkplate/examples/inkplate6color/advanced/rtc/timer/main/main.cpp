 ...
 *
 * @details     Sets the on-board RTC to a configured time and starts a 50-second
 *              countdown timer using the RTC hardware timer at 1 Hz. The current
 *              time is refreshed on the display every minute. When the countdown
 *              reaches zero, "Timer!" is shown and the timer is disabled.
 *
 * Requirements:
