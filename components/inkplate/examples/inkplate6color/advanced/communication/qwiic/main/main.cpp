 ...
 *
 * @details     Scans the I2C bus (shared with the Qwiic connector) for connected
 *              devices and displays their addresses on the e-paper screen. The scan
 *              repeats every 5 seconds so newly attached peripherals are detected
 ...
 * 3) The display shows addresses of detected devices, refreshing every 5 seconds.
 *
 * Expected output:
 * - A list of detected I2C addresses, or "No devices found." if none are connected.
 *
 * Notes:
 * - The scan covers addresses 0x01-0x7E.
 * - The I2C bus handle is provided by the Inkplate driver via the extern I2C object.
 *
