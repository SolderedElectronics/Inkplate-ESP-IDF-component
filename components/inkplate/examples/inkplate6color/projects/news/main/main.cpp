 ...
 *
 * @details     Connects the Inkplate 6Color to WiFi (credentials configured
 ...
 *              drawTextBox() using two custom fonts.
 *
 ...
 * 4) Build and flash to Inkplate 6Color.
 ...
 *
 * Notes:
 * - Inkplate 6Color is a 7-color e-paper board (black, white, green, blue,
 *   red, yellow, orange) with a single fixed color display mode - there is
 *   no setDisplayMode() call on this board. This example only draws with
 ...
 *   (display.display()); Inkplate 6Color does not support partial updates.
 ...
 *   adapt automatically to the resulting canvas size.
 ...
 *   applied manually here (same approach as this component's Inkplate 6 news
 *   example, and equivalent to the original sketch's fixed `timeZone`
 *   variable).
