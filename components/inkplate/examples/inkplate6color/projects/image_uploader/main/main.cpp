 ...
 * @brief       WiFi image uploader for Soldered Inkplate 6Color.
 *
 * @details     Turns Inkplate 6Color into a small standalone web app for
 ...
 *              7-color e-paper display, dithering it down to the panel's
 *              7-color palette.
 *
 * Requirements:
 ...
 *    panel's 7-color palette, on the e-paper display.
 *
 * Expected output:
 ...
 * - Inkplate 6Color supports 7 colors: black, white, green, blue, red,
 *   yellow, orange. display.image.draw() dithers the uploaded image down to
 *   this palette.
 *
