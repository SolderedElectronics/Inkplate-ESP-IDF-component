 ...
 *              summary of what changed compared to the original HTTPClient +
 *              ArduinoJson version. The Open-Meteo query parameters are
 *              unchanged from the original sketch (same fields requested for
 *              this board as for the grayscale Inkplate6 port), even though
 *              this board's Gui.cpp only displays a subset of them.
 *
