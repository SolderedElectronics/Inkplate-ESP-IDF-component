 ...
 * @brief       Spotify "now playing" dashboard for Soldered Inkplate 6Color.
 *
 * @details     Connects Inkplate 6Color to WiFi, refreshes a Spotify OAuth2
 ...
 *              the album cover art on the 7-color e-paper panel.
 *
 ...
 *
 * Notes:
 * - Display: Inkplate 6Color's native 7-color e-paper mode (no
 *   setDisplayMode() call - this board only has one display mode). Colors
 *   used: INKPLATE_BLACK/WHITE.
 * - Orientation: both dashboard screens rotate the panel into portrait
 *   (setRotation() in Gui.cpp) since the layout is a centered column; the
 *   native panel is 600x448 landscape.
