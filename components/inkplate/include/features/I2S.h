...
public:
   ...
   * 
   * @param clockDivider I2S master clock divider; BCK frequency = 80 MHz / clockDivider.
   * 
   ...
   * @param function I2S signal index from gpio_sig_map.h (e.g. I2S1O_DATA_OUT0_IDX).
