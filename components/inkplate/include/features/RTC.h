...
public:
   ...
   * @return esp_err_t i2c error code.
   * 
   * @note Trying to display month or year will result in defined behavour as alarm doesn't 
   * have month and year registers.
   */
   ...
   * 
   * @param mode 0 - offset made once every two hours, 1 - offset made every four minutes.
