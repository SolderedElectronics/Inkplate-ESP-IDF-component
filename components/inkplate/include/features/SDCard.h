...
public:
   ...
   * 
   * @note Store a reference to the IO expander used to control the SD power switch.
   */
   ...
   *        Sets all SPI lines and the power switch pin as inputs to minimise current draw.
   * 
   * @return esp_err_t error code.
   */
