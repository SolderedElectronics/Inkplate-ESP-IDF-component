...
public:
   ...
   * 
   * @param r screen rotation, 0 is normal, 1 is left, 2 is upsidedown and 3 is right.
   */
   ...
   * @param vericalSpacing vertical spacing (in pixels) between lines of text; if 0 or NULL, defaults to text height + padding.
